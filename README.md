...
# Neuro-EarlyDetect: Collaborate on Next-Gen Neurodegenerative Disease Detection
...
## License
This project is licensed under the [MIT License](LICENSE). Feel free to use, modify, or distribute, but please do so responsibly and credit the contributors.
